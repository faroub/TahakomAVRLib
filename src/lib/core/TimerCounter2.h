...
public:
    ...
    static void outputCompareMatchAServiceRoutine() __asm__(STR(TIMER2_COM_CHANNEL_A_INTERRUPT)) __attribute__((__signal__, __used__, __externally_visible__));

    static void outputCompareMatchBServiceRoutine() __asm__(STR(TIMER2_COM_CHANNEL_B_INTERRUPT)) __attribute__((__signal__, __used__, __externally_visible__));

    static void overflowServiceRoutine() __asm__(STR(TIMER2_OVERFLOW_INTERRUPT)) __attribute__((__signal__, __used__, __externally_visible__));
